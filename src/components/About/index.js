        ...
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <div className="flex justify-center">
            <a
              ...
              className="inline-flex text-white bg-foam border-0 py-2 px-6 focus:outline-none hover:text-foam hover:bg-red rounded text-lg">
              Work With Me
            </a>
            <a
              href="#projects"
              onClick={() => setCurrentCategory('projects')}
              className="ml-4 inline-flex text-white bg-foam border-0 py-2 px-6 focus:outline-none hover:bg-red hover:text-foam rounded text-lg">
              See My Past Work
            </a>
          </div>
        </div>
